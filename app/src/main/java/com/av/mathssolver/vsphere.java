...
public class vsphere extends AppCompatActivity {
    public EditText r;
    Button ans;
    TextView res;
    ImageButton back3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vsphere);
        ...
        back3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(vsphere.this,Volume.class);
