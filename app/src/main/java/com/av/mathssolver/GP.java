...
public class GP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gp); radioGroup = findViewById(R.id.radioGroup);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(GP.this, apGpHp.class);
        ...
        gen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(check ==1)
                {
                    double tn =a*Math.pow(d,n-1);
                    res.setText("t"+(int)n+": "+String.valueOf(tn));
                }
                else if(check ==2)
                {
                    double s =a * ((Math.pow(d,n)) - 1);
                    double sn = s / (d-1);
