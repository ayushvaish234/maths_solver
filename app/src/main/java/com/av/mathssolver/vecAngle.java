...
public class vecAngle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vec_angle);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(vecAngle.this, vecSel.class);
        ...
        r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (x1.getText().toString().equals("")) {
                    ...
                    double mag1= Math.pow(y1*y1 +y2*y2 +y3*y3 , 0.5);
                    double mag2= Math.pow(y4*y4 +y5*y5 +y6*y6 , 0.5);
                    Double d = (y1 * y4) + (y2 * y5) +(y3 * y6);
                    double result = d/(mag1*mag2);
                    res.setText(String.format("%.2f",d)+"/ ("+String.format("%.2f",mag1)+"*"+String.format("%.2f",mag2)+") or\n"+String.format("%.2f",result));
                }
            }
        });
